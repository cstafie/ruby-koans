...
class AboutSymbols < Neo::Koan
  ...
  # Maybe it's a chicken and egg problem?
  # The symbol we are asking for might cause it to be in Symbol.all_symbol 
  # in the first place
  ...
  def test_symbols_cannot_be_concatenated
    ...
    assert_raise(StandardError) do # had to google about asser_raise to find StandardError
      :cats + :dogs
    end
  end
